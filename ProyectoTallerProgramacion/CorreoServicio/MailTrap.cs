...
{
    /// <summary>
    /// Clase utilizada para relacionar el programa con el servicio de correo correspondiente a MailTrap.
    /// </summary>
    public class MailTrap : ServicioCorreo
    {
        /// <summary>
        /// Constructor de la clase. Llama al constructor de la superclase pasandole como parametro
        /// el nombre del Servicio de Correo.
        /// </summary>
        public MailTrap() : base("MailTrap") { }
        ...
        public override void EnviarCorreo(CorreoDTO pCorreo, CuentaDTO pCuenta)
        {
            ...
            try
            {
                ...
                SmtpClient cliente = new SmtpClient("mailtrap.io");
                cliente.EnableSsl = true;
                cliente.Port = 2525; // o 465, o 25
        ...
        public override IList<CorreoDTO> DescargarCorreos(CuentaDTO pCuenta)
        {
            ...
            try
            {
                pop.Connect("mailtrap.io", 1100, true); // o 9950
